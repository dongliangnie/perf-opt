...
static RetCode_t prepare_kf_input(int horizon, KfInput *input) {
    ...
    input->measurements = (double *)aligned_calloc(measurement_count, sizeof(double));
...
static void *aligned_calloc(size_t count, size_t size) {
    ...
    if (posix_memalign(&ptr, KF_ALIGNMENT_BYTES, total_size) != 0) {
        return NULL;
    }
...
static RetCode_t create_workspace(size_t dim, KfWorkspace **workspace_out) {
    ...
    *workspace_out = NULL;
    ...
    workspace->x = (double *)aligned_calloc(dim, sizeof(double));
    workspace->p = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->q = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->r = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->k = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->identity = (double *)aligned_calloc(matrix_count, sizeof(double));

    workspace->temp_p_plus_r = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->inv_temp_p_plus_r = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->temp_i_minus_k = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->p_old = (double *)aligned_calloc(matrix_count, sizeof(double));
    workspace->z_minus_x = (double *)aligned_calloc(dim, sizeof(double));
    workspace->k_mult_z_minus_x = (double *)aligned_calloc(dim, sizeof(double));
...
static void mat_mul(const double *a,
                    ...
                    size_t m) {
    /*
     * ARM software prefetch + inner j-loop unrolling.
     * The loop order remains i-l-j.
     */
